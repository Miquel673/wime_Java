      ...
      <div class="collapse mt-2" id="opciones-${tarea.idTarea}">
        ...
        <div class="dropdown mb-2">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#" onclick="cambiarEstadoTarea(${tarea.idTarea}, 'en_progreso')">En progreso</a></li>
        ...
        <div class="card-body">
          ...
          <div class="collapse mt-2" id="opciones-rutina-${rutina.idRutina}">
            ...
            <div class="d-flex justify-content-end mt-3">
              <a href="/HTML/Modules/Wime_interfaz_Modulo_ERutinas.html?id=${rutina.idRutina}" class="btn btn-sm btn-outline-secondary">Editar</a>
            </div>
          </div>
        </div>
      </div>
...
async function cambiarEstadoTarea(id, nuevoEstado) {
  try {
    ...
    if (data.success) {
      await cargarTareas();              // refresca tarjetas
      await cargarTareasCalendario();    // refresca array calendario
      renderizarCalendario();            // vuelve a dibujar calendario
    } else {
